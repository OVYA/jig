  ...
  function(
     ...
     */
      ...
      buildRendering: function() {
        ...
        domClass.add(
          this.domNode,
          this["class"] + " " + this.extraClass + " " + this.cssClasses
        );
      ...
      onClick: function(evt) {
        ...
        if (!this.confirm || window.global.confirm(this.confirm)) {
      ...
      onExecute: function() {
        if (this.autoInstanciate) {
          ...
          require("geonef/jig/workspace").autoAnchorInstanciate(
            this.autoInstanciate,
            null,
            this.autoInstanciateOptions
          );
        }
      },
