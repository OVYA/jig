...
define(
      ...
      get: function(id, options) {
        ...
        if (obj && (!options || (!options.fields && !options.fieldGroup))) {
          ...
          return this.apiRequest(
            lang.mixin({ action: "get", id: id }, options),
            options ? options.api : {}
          ).then(function(resp) {
            if (resp.error) {
      ...
      query: function(filter, options) {
        ...
        return this.apiRequest(
          ...
          lang.hitch(this, function(resp) {
            if (!resp.results) {
              console.error(
                "model query (" + this.apiModule + "): no result array",
                resp
              );
              return null;
            }
            return async.whenAll(
              resp.results.map(function(data) {
        ...
        if (discrProp) {
          ...
          if (!discrValue || !_class) {
            console.error(
              ...
              "makeObject(): invalid discriminator '" +
                discrProp +
                "': " +
                discrValue
            );
   ...
   */
      apiRequest: function(params, options, object) {
        ...
        return api.request(
          lang.mixin({ module: module, scope: this }, this.apiParams, params),
          options
        );
      },
