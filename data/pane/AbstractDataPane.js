  ...
  function(
     ...
     */
      ...
      makeDropDownNode: function(title) {
        ...
        var node = this.dom([
          DropDownButton,
          {
            ...
            dropDown: new TooltipDialog({
              class: "jigActionsTooltip jigDataPaneTooltip"
            }),
            onMouseEnter: lang.hitch(
              null,
              domClass.add,
              this.domNode,
              "overDD"
            ),
            onMouseLeave: lang.hitch(
              null,
              domClass.remove,
              this.domNode,
              "overDD"
        ...
        this.dom([
          "div",
          { _insert: this.optionsDD.dropDown.containerNode },
          [
            ["h2", {}, title || ""],
     ...
     */
      onModelChannel: function(object, type) {
        if (object !== this.object || this._destroyed) {
          return;
        }
     ...
     */
      ...
      deleteObject: function() {
        if (!window.global.confirm(this.removeConfirm)) {
          return;
        }
        this.object.store.remove(this.object).then(async.busy(this.domNode));
      },
