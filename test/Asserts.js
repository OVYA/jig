 ...
 * Test assertions
 */
define(["module", "dojo/_base/declare"], function(module, declare) {
  "use strict";
  ...
  return declare(null, {
    ...
    instanceOf: function(_class, obj, message) {
      return this.passOrFail(obj instanceof _class, [
        "assert instanceOf " +
          (_class.name ||
            _class.prototype.declaredClass ||
            _class.prototype.CLASS_NAME),
        message,
        obj
      ]);
    },
