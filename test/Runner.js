   ...
   */
      group: function(nameOrScope, func) {
        ...
        try {
          ...
          this.fail(
            "-- SYNC EXEC EXCEPTION '" + error.name + ": " + error.message
          );
          finish();
   ...
   */
      hitchGroup: function(nameOrScope, func) {
        return lang.hitch.apply(
          null,
          lang._toArray(arguments, 0, [this, this.group])
        );
      },
   ...
   */
      classGroup: function(TestClass, options) {
        var name =
          ...
          TestClass.prototype.declaredClass ||
          "<class>";
        var _this = this;
   ...
   */
      ...
      showReport: function() {
        ...
        var dumpGroup = function(group, dontCollapse) {
          ...
          info +=
            "ok=" +
            group.totalSuccessCount +
            "" +
            "   fail=" +
            group.totalFailureCount +
            "";
          info += "";
