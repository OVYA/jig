  ...
  function(declare, Asserts, syncTest, async, lang) {
    ...
    return function(test) {
      ...
      return test
        ...
        .then(
          test.hitchGroup(function handleTimeout(test, arg) {
        ...
        .then(
          test.hitchGroup(function installAndHandleTimeout(test, arg) {
        ...
        .then(function(arg) {
          ...
          return async.whenTimeout(delay).then(
            test.hitchGroup(function handleTimeoutOnly() {
